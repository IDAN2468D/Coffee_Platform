...
export default function MolecularPairingPage() {
  ...
  return (
    <AuthGuard>
      <div className="min-h-screen bg-obsidian text-stone-100 flex flex-col relative overflow-hidden dir-rtl">
        {/* Ambient Glows */}
        <div className="absolute top-10 right-10 w-96 h-96 bg-indigo-500/10 rounded-full filter blur-[120px] pointer-events-none animate-pulse-slow" />
        <div className="absolute top-1/2 left-10 w-80 h-80 bg-pink-500/10 rounded-full filter blur-[100px] pointer-events-none animate-float" />
