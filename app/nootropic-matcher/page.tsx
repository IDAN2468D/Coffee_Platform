...
import { NootropicWellnessMatcher } from '@/components/NootropicWellnessMatcher';
...
export default function NootropicMatcherPage() {
  ...
  return (
    <AuthGuard>
      <div className="min-h-screen bg-obsidian text-stone-100 flex flex-col relative overflow-hidden dir-rtl">
        ...
        <div className="absolute top-1/2 left-10 w-80 h-80 bg-red-500/10 rounded-full filter blur-[100px] pointer-events-none animate-float" />
